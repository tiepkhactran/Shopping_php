...
class BrandProduct extends Controller
{
    ...
    public function all_brand_product(){
        $this->AuthLogin();
//        lấy dữ liệu trong bảng all_brand_product gán vào biến $all_brand_product
        $all_brand_product = DB::table('tbl_brand')->get();
//         Lấy dữ liệu từ $add_brand_product gán vào biến add_brand_product
...
//        thêm dữ liệu vào bảng tbl_brand_product
