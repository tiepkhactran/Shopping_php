...
class ProductController extends Controller
{
    ...
    public function all_product(){
        $this->AuthLogin();
//        lấy dữ liệu trong bảng all_product gán vào biến $all_product
        $all_product = DB::table('tbl_product')
            ->join('tbl_category_product','tbl_category_product.category_id','=','tbl_product.category_id')
            ->join('tbl_brand','tbl_brand.brand_id','=','tbl_product.brand_id')
            ->orderby('tbl_product.product_id','desc')->get();
//         Lấy dữ liệu từ $add_product gán vào biến add_product
...
//        thêm dữ liệu vào bảng tbl_product
    ...
    public function edit_product($product_id){
        ...
        ->with('category_product',$category_product)->with('brand_product',$brand_product);
