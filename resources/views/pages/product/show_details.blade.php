            ...
            <div class="col-sm-7">
                <div class="product-information"><!--/product-information-->
                    ...
                    <form action="{{URL::to('/save-cart')}}" method="POST">
                        {{csrf_field()}}
                        <span>
				        <span>Giá: {{number_format($value->product_price).'VNĐ'}}</span>
                        ...
                        @foreach($related as $key =>$lienquan)
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{URL::to('public/upload/product/'.$lienquan->product_image)}}"
                                                 alt=""/>
                                            <h2>Giá: {{number_format($value->product_price).'VNĐ'}}</h2>
